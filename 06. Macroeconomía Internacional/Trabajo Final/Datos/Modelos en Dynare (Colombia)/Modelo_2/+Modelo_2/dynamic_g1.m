...
if T_flag
    T = Modelo_2.dynamic_g1_tt(T, y, x, params, steady_state, it_);
end
g1 = zeros(13, 21);
g1(1,4)=(-((1-params(1))*1/y(8)));
g1(1,8)=getPowerDeriv(y(8),params(4)-1,1)-(1-params(1))*(-y(4))/(y(8)*y(8));
g1(2,17)=(-(T(4)*params(1)*1/y(6)/(1+params(5)*(y(6)-y(1)))));
g1(2,5)=T(11);
g1(2,18)=(-(T(5)*params(9)*T(12)/(1+params(5)*(y(6)-y(1)))));
g1(2,1)=(-((-(T(6)*(-params(5))))/((1+params(5)*(y(6)-y(1)))*(1+params(5)*(y(6)-y(1))))));
g1(2,6)=(-(((1+params(5)*(y(6)-y(1)))*T(4)*(params(1)*(-y(17))/(y(6)*y(6))-params(5))-params(5)*T(6))/((1+params(5)*(y(6)-y(1)))*(1+params(5)*(y(6)-y(1))))));
g1(2,19)=(-(T(4)*params(5)/(1+params(5)*(y(6)-y(1)))));
g1(2,8)=T(13);
g1(2,20)=(-(T(5)*T(14)/(1+params(5)*(y(6)-y(1)))));
g1(3,5)=T(11);
g1(3,18)=(-((1+y(16))*params(9)*T(12)));
g1(3,8)=T(13);
g1(3,20)=(-((1+y(16))*T(14)));
g1(3,16)=(-T(4));
g1(4,4)=(-1);
...
g1(5,9)=(-(T(8)*T(10)));
g1(6,3)=(-(params(11)*exp(y(3)-params(10))));
g1(6,15)=1;
g1(7,1)=(-(1-params(2)));
g1(7,6)=1;
g1(7,7)=(-1);

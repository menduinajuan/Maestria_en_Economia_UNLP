function [nGAMA,nDELTA,nALFA,nPSI,nRHO,nOMEGA,nPHI,nR,nc,ncp,nh,nhp,nk,nkp,nk1,nk1p,nd,ndp,ni,nip,ntb,ntbp,nla,nlap,ny,nyp,na,nap,ntby,ntbyp,ncay,ncayp]=mendoza91s_ss
%This program produces the deep structural parameters and computes the steady state of a small open economy model with an endogenous discount factor (but without internalization) described in ``Closing Small Open Economy Models,'' by S. Schmitt-Grohe and Martin Uribe. 

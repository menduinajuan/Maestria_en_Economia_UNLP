%This program computes a log-linear approximation to the policy function of a small open economy with an endogenous discount factor but without internalization (see ``Closing Small Open Economy Models,'' by Stephanie Schmitt-Grohe and Martin Uribe). The reduced form of the model can be written as: %E_t[f(yp,y,xp,x)=0, 
%
...
%
%Calls: mendoza91s.m gx_hx.m mom.m and ir.m
% 
%(c) Stephanie Schmitt-Grohe and Martin Uribe
%
%Date November 8, 2001

[fx,fxp,fy,fyp] = mendoza91s;

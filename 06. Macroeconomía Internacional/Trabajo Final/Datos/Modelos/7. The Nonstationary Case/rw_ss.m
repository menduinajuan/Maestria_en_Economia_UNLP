function [nGAMA,nDELTA,nALFA,nRHO,nOMEGA,nPHI,nR,nDBAR,nc,ncp,nh,nhp,nk,nkp,nk1,nk1p,nd,ndp,ni,nip,ntb,ntbp,nla,nlap,ny,nyp,na,nap,ntby,ntbyp,ncay,ncayp]=rw_ss
%This program produces the deep structural parameters and computes the steady state of a small open economy model without stationarity inducing features described in ``Closing Small Open Economy Models,'' by S. Schmitt-Grohe and Martin Uribe. 
...
nDBAR =  0.74421765717098; %parameter of portfolio adjustment cost function

...
[T_order, T] = Modelo_3.sparse.static_g1_tt(y, x, params, T_order, T);
g1_v = NaN(37, 1);
...
g1_v(9)=T(7)-(1+y(12))*params(9)*T(7)/(1-params(11)*(y(9)-params(10)));
g1_v(10)=1;
g1_v(11)=100;
...
g1_v(20)=T(8)-(1+y(12))*params(9)*T(8)/(1-params(11)*(y(9)-params(10)));
...
g1_v(26)=1;
g1_v(27)=1;
g1_v(28)=(-((-(T(2)*params(9)*(1+y(12))*(-params(11))))/((1-params(11)*(y(9)-params(10)))*(1-params(11)*(y(9)-params(10))))));
g1_v(29)=1+y(12)+params(11)/2*2*(y(9)-params(10))-1;
g1_v(30)=y(12)+params(11)*(exp(y(9)-params(10))-1)+y(9)*params(11)*exp(y(9)-params(10));
g1_v(31)=1;
g1_v(32)=(-1);
g1_v(33)=1;
g1_v(34)=(-(T(2)*params(9)/(1-params(11)*(y(9)-params(10)))));
g1_v(35)=y(9);
g1_v(36)=y(9);
g1_v(37)=1;

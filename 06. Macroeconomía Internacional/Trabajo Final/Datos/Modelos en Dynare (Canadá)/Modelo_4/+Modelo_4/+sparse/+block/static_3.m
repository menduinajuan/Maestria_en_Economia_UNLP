...
g1_v(6)=(-1);
g1_v(7)=1;
g1_v(8)=(-((1-params(1))*1/y(5)));
g1_v(9)=(-100);
g1_v(10)=(-(T(5)*params(9)*params(1)*1/y(3)));
g1_v(11)=(-(T(3)*y(6)*getPowerDeriv(y(3),params(1),1)));
g1_v(12)=1-(1-params(2));
g1_v(13)=(-(T(5)*params(9)*params(1)*(-y(1))/(y(3)*y(3))));
g1_v(14)=(-(T(2)*getPowerDeriv(y(5),1-params(1),1)));
g1_v(15)=getPowerDeriv(y(5),params(4)-1,1)-(1-params(1))*(-y(1))/(y(5)*y(5));
g1_v(16)=T(7)-(1+params(1)*y(1)/y(3)-params(2))*params(9)*T(7);
g1_v(17)=1;
g1_v(18)=(-(params(9)/(params(9)-1)));
g1_v(19)=(-(1/params(9)));
g1_v(20)=y(14);
g1_v(21)=1;
g1_v(22)=1;

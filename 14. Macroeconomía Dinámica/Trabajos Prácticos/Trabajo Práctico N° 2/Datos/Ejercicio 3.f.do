...
graph twoway (line y t, lcolor(black)) (line y_nss t, lcolor(red)), title("Evolución temporal de y (rho=0.1)", color(black)) ///
...
graph twoway (line y t if (t<=25), lcolor(black)) (line y_nss t if (t<=25), lcolor(red)),	title("Función impulso-respuesta de y (rho=0.1)", color(black)) ///
																							ytitle("y") xtitle("Tiempo") legend(label(1 "y_t") label(2 "y_nss"))
...
graph twoway (line y t, lcolor(black)) (line y_nss t, lcolor(red)), title("Evolución temporal de y (rho=0.9)", color(black)) ///
																	ytitle("y") xtitle("Tiempo") legend(label(1 "y_t") label(2 "y_nss"))
...
graph twoway (line y t if (t<=25), lcolor(black)) (line y_nss t if (t<=25), lcolor(red)),	title("Función impulso-respuesta de y (rho=0.9)", color(black)) ///
																							ytitle("y") xtitle("Tiempo") legend(label(1 "y_t") label(2 "y_nss"))
* Equilibrio General Computable - Trabajo Práctico N° 3 (Ejercicios 1 a 4)
* Juan Menduiña
...
PARAMETER
  ...
  WALRAS0        walras (agregada al exogeneizar WL y KL y al establecer como numerario a CPI)
...
* 1. Aumentar 15% la dotación de trabajo
...
* 2. Aumentar 15% el precio mundial del bien X

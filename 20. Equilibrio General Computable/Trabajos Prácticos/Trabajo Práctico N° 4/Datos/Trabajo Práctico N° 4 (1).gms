* Equilibrio General Computable - Trabajo Práctico N° 4 (Ejercicio 1)
* Juan Menduiña
...
DISPLAY QA.L, QD.L, QE.L, QM.L, QX.L, QQ.L, QINT.L, QH.L, qg, QINV.L, qdstk, EG.L, LD.L, KD.L,
        PA.L, PD.L, PE.L, PM.L, PX.L, PQ.L, CPI.L, EXR.L, WL.L, WK.L, YH.L, YL.L, YK.L, trnsfr, WALRAS.L;

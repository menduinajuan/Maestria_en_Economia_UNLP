* Equilibrio General Computable - Trabajo Práctico N° 1
* Juan Menduiña
...
PARAMETERS
  ...
  phi_m        parámetro eficiencia sector M
...
TY0 = (TRNSFR0 - taa * PA0 * QA0 - tam * PM0 * QM0) / (YL0 + YK0 + TRNSFR0);
DISPLAY taa, tam, TY0;
...
* Consumo
  ...
  EQ_HHDDEMA      demanda producto A hogares
  EQ_HHDDEMM      demanda producto M hogares
...
EQ_GOVINC..
  TRNSFR =E= taa * PA * QA + tam * PM * QM + TY * (YL + YK + TRNSFR);

EQ_HHDINC..
  YH =E= (1 - TY) * (YL + YK + TRNSFR);
...
DISPLAY QA.L, QM.L, QHA.L, QHM.L, LDA.L, KDA.L, LDM.L, KDM.L, WL.L, WK.L, PA.L, PM.L, YL.L, YK.L, YH.L, TRNSFR.L, TY.L, walras;
...
* 1. Establecer la tasa del impuesto directo en 20%
...
* 2. Endogeneizar la tasa del impuesto directo, exogeneizar la recaudación tributaria y establecer las tasas de los impuestos indirectos en 0%
